        ...
        body: Container(
            ...
            child: Theme(
              ...
              child: FlutterLogin(
                ...
                theme: LoginTheme(
                  primaryColor: const Color(0xFF53516E),
                  ...
                  inputTheme: InputDecorationTheme(
                    ...
                    focusedBorder: UnderlineInputBorder(
                      borderSide:
                          BorderSide(color: Colors.green.shade400, width: 5),
                      borderRadius: inputBorder,
                    ),
                    errorBorder: UnderlineInputBorder(
                      borderSide:
                          BorderSide(color: Colors.green.shade700, width: 7),
                      borderRadius: inputBorder,
                    ),
                    focusedErrorBorder: UnderlineInputBorder(
                      borderSide:
                          BorderSide(color: Colors.green.shade400, width: 8),
                      borderRadius: inputBorder,
                    ),
